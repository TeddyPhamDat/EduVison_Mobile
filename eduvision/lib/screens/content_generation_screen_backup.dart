...
class _ContentGenerationScreenState extends State<ContentGenerationScreen> {
  ...
  String _selectedMode = 'slides'; // Default to slides
  ...
  final List<String> _availableModes = ['Slides', 'Video'];
