...
class AuthService {
  ...
  Future<User> signIn({required String email, required String password}) async {
    try {
      ...
      // Sử dụng model AuthResponse từ auth_response.dart
      ...
      // Tạo đối tượng LoginResult từ AuthResult để tương thích với code hiện tại
      ...
      await _saveTokenAndUser(loginResult.token, loginResult);
      _authStateController.add(_currentUser);
